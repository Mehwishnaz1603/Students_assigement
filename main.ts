// 3.Friend checker game // • Prompt the user to enter a name.
...
async function freindCheckerGame() {
    let friendsName = await inquirer.prompt([{
        name: "friendName", type: "input", message: "Enter Your Friend Name:"
    }]);
    switch (friendsName.friendName) {
        ...
        case "Amna":
            ...
            break;
        default: console.log("Sorry, the name entered is not a known friend.") }
};    freindCheckerGame();
