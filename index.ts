...
let variable2= 27
let profile_1= function () {   //callig function
...
// 5.Calculator project using function:  • Set up two variables containing number values.
// • Set up a variable to hold an operator (+ or -).  • Create a function that takes two numbers and an operator as 
//parameters, performs the corresponding operation, and returns the result.
...
// let num1 = 10;    // let two variables contain number values
// let num2 = 5;
// let operator= '+ '     // let a variable to contain an operator (+ or -)
// function calculate(num1:number, num2:number, operator:any) {  // Create a function to perform the operation
//     switch (operator) {
//         case '+':
//             return num1 + num2;
//         case '-':
